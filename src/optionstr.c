...
static __thread char *(p_dip_values[]) = {"filler", "context:", "iblank", "icase", "iwhite", "iwhiteall", "iwhiteeol", "horizontal", "vertical", "closeoff", "hiddenoff", "foldcolumn:", "followwrap", "internal", "indent-heuristic", "algorithm:", NULL};
...
static __thread char *(p_popup_option_values[]) = {"height:", "width:", "highlight:", "border:", "align:", NULL};
static __thread char *(p_popup_option_border_values[]) = {"on", "off", NULL};
...
static __thread char *(p_wim_values[]) = {"full", "longest", "list", "lastused", NULL};
