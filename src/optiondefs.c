...
void set_init_default_options() {
  ...
  struct vimoption default_options[] =
    {
...
#define p_term(sss, vvv)                                    \
  ...
  // Copy this to the options_ptr.
  options_ptr = malloc(sizeof(default_options));
  memcpy(options_ptr, default_options, sizeof(default_options));
  OPTION_COUNT = ARRAY_LENGTH(default_options);
}
